        ...
        public async Task<IActionResult> Login([FromBody] LoginDto dto)
{
    ...
    if (user.IsDeleted)
    {
        _logger.Warning("Login failed - user {Username} is disabled", dto.Username);
        return Unauthorized(new { success = false, message = "User has been disabled. Please contact Admin." });
    }
